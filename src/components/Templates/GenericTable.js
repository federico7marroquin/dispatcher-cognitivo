...
// Generate Order Data
// function createData( date, name, typology, subject, description) {
//     return { id, date, name, typology, subject, description };
// }
        ...
        <TableHead>
            <TableRow>
                ...
                {headCells.map((headCell) => (
                    <TableCell
                        key={headCell.id}
                        align={headCell.label === 'Fecha' || headCell.label === 'Último Ingreso' ? 'right' : 'left'}
